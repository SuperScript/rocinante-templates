...
- Register pubkey /root/.ssh/rocinante@$(hostname -s) as sst-rocinante in github.
...
- Set up a laptop host: `rocinante template superscript/rocinante-templates/setup --arg REPO=git@github.com:superscript/rocinante-private --arg TEMPLATE=superscript/rocinante-private/laptop`
